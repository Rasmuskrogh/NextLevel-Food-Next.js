...
export async function saveMeal(meal) {
  try {
    console.log("Starting saveMeal function...");
    ...
    // Spara måltiden med Cloudinary URL
    const mealWithImage = {
      ...meal,
    ...
    await pool.query(
      `INSERT INTO meals (title, summary, instructions, image, creator, creator_email)
       VALUES ($1, $2, $3, $4, $5, $6)`,
      [
        mealWithImage.title,
    ...
    console.error("Detailed error in saveMeal:", {
