...
export const shareMeal = async (prevState, formData) => {
  //  console.log("MEALS, SHARE MEAL", meal.image);
  ...
  console.log("🔄 Received file in shareMeal:", file);
  if (!file || file.size === 0) {
  ...
  const imageUrl = `${process.env.NEXT_PUBLIC_SUPABASE_URL}/storage/v1/object/public/meal-images/${data.path}`;
